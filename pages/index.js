          ...
          <SmoothWrapper>
            ...
            >
              <m.div variants={fade}>
                ...
                <section className="pt-[14vw] md:pt-[6vw] xl:pt-[5vw]">
                      ...
                      {home.rolesFilled.map((e, i) => {
                        return (
                          <li className={`text-yellow pt-2 pb-2 md:pt-2 md:pb-[6px] fancy-nav__item group md:hover:text-off-black relative overflow-hidden`} key={i}>
                            ...
                            <span className="block bg-yellow-dark md:group-hover:bg-yellow transition ease-in-out duration-[300ms] h-[1px] w-full absolute bottom-0 left-0 right-0 z-0">
                            </span>
                            <span className={`block delay-150 bg-yellow-dark md:group-hover:bg-yellow transition-all ease-in-out duration-[300ms] h-[1px] ${ i == 0 ? 'mt-[0px]' : 'mt-[-1px]' } md:group-hover:mt-0 w-full absolute top-0 left-0 right-0 z-0`}>
                            </span>
                            
                            <span className="flex flex-wrap items-center rounded-xl md:py-2 2xl:py-2 md:group-hover:pl-5 md:group-hover:pr-5 md:group-focus-visible:pl-5 relative z-10 md:group-focus-visible:pr-5 transition-all ease-in-out duration-500">
                              <span className="w-1/2 md:flex-1 text-lg md:text-2xl xl:text-3xl 2xl:text-4xl leading-right md:leading-tight md:-translate-x-8 xl:-translate-x-14 md:group-hover:translate-x-0 transition-transform ease-in-out duration-500 flex items-center">
                                ...
                                <RevealOnEnter>
                                  <span className="block overflow-hidden relative">
                                    <span className="block leading-0 md:group-hover:-translate-y-[120%] transition-transform ease-in-out duration-500">{e.title}</span>
                                    <span className="block leading-0 absolute inset-0 translate-y-full md:group-hover:translate-y-0 transition-transform ease-in-out duration-500">{e.title}</span>
                                  </span>
                                </RevealOnEnter>
                              </span>
                              ...
                              <RevealOnEnter>
                                <span className="block overflow-hidden relative">
                                  <span className="block leading-0 md:group-hover:-translate-y-[120%] transition-transform ease-in-out duration-500">{e.type}</span>
                              ...
                              <span className="w-1/2 md:flex-1 text-lg md:text-2xl xl:text-3xl 2xl:text-4xl leading-right md:leading-tight hidden md:block">
                                <RevealOnEnter>
                                  <span className="block overflow-hidden relative">
                                    <span className="block leading-0 md:group-hover:-translate-y-[120%] transition-transform ease-in-out duration-500">{e.client}</span>
                              ...
                              <span className="block w-1/2 md:w-auto text-lg md:text-2xl xl:text-3xl 2xl:text-4xl leading-right md:leading-tight ml-auto text-right md:text-left">
                                <RevealOnEnter>
                                  <span className="block overflow-hidden relative">
                                    <span className="block leading-0 md:group-hover:-translate-y-[120%] transition-transform ease-in-out duration-500">{e.year}</span>
