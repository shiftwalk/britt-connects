              ...
              <m.div variants={fade}>
                <section className="h-screen relative p-3 md:p-4 xl:p-6">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center z-0" data-scroll data-scroll-speed={-0.55}>
                    <div className="relative overflow-hidden w-[88vw] md:w-[50vw] lg:w-[45vw] xl:w-[44vw] 2xl:w-[42vw] h-[33vh] md:h-[50vh] lg:h-[63vh] xl:h-[64vh] 2xl:h-[68vh] rounded-xl rotate-[-3deg] max-w-[840px] hero-image mt-[-15vh] md:mt-[4vw] lg:mt-[10vh] xl:mt-[10vh]">
                      <Image
                  ...
                  <div className="absolute bottom-0 xl:mb-[12.5vh] left-0 p-3 md:p-4 xl:p-6 max-w-[80vw] md:max-w-[36vw] lg:w-[26vw]" data-scroll data-scroll-speed={0.7}>
                    <p className="indent-9 text-base lg:text-lg lg:leading-snug xl:text-xl xl:leading-snug 2xl:text-2xl 2xl:leading-snug">Finding the best people is a critical investment, not a luxury. And it happens to be our superpower. We connect top-tier talent with high-caliber opportunities. We care deeply about our talent and partner only with clients who feel the same, meaning we value personal connections over numbers and transactions.</p>
                    ...
                    <ul className="leading-tight xl:leading-tight text-sm xl:text-lg 2xl:text-xl 2xl:leading-tight flex flex-wrap md:hidden mt-5">
                      ...
                      <li className="w-1/2">Creative Directors</li>
                      <li className="w-1/2">UX Designers</li>
                      <li className="w-1/2">UI Designers</li>
                      <li className="w-1/2">Graphic Designers</li>
                      <li className="w-1/2">Engineers</li>
                      <li className="w-1/2">Creative Technologists</li>
                      <li className="w-1/2">3D Designers</li>
                      <li className="w-1/2">Motion Designers</li>
                    </ul>
                  </div>

                  <div className="absolute bottom-0 right-0 p-3 md:p-4 xl:p-6 max-w-[70vw] md:max-w-[36vw] lg:w-[28vw] hidden md:block xl:mb-[12.5vh]" data-scroll data-scroll-speed={0.7}>
                  ...
                  <div className="relative flex justify-center">
                    <div className="px-[3vw] md:px-[10vw] flex flex-wrap items-center justify-center">
                      <div className="w-full pt-[10vw]">
                        ...
                        <h3 className="text-[9vw] md:text-[5.6vw] font-display uppercase leading-[0.92] md:leading-[0.92] text-center relative z-10 mix-blend-lighten w-full mb-12 md:mb-12" data-scroll data-scroll-speed={1.1}>“Britt has an incredible knack of reading between the lines to find perfect candidates”</h3>
                        ...
                        <span className="block mx-auto text-center uppercase text-lg leading-tight md:text-xl md:leading-tight" data-scroll data-scroll-speed={1.1}>Kelly Wu<span className="block">Recruiting Lead, Google</span></span>
                      </div>
                    </div>

                    <div className="opacity-25 absolute inset-0 z-0 w-full h-full flex items-center justify-center">
                      <div className="w-10/12 md:w-5/12 overflow-hidden py-[1vw]">
