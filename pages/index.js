                  ...
                  <div className="relative flex justify-center">
                    <div className="px-[3vw] md:px-[10vw] flex flex-wrap items-center justify-center">
                      <div className="w-full pt-[10vw]">
                        ...
                        <h3 className="text-[9vw] md:text-[5.6vw] font-display uppercase leading-[0.92] md:leading-[0.92] text-center relative z-10 mix-blend-lighten w-full mb-12 md:mb-12" data-scroll data-scroll-speed={1.1}>“{home.quote.text}”</h3>
