...
export default function Header({ bioImage, bioHeading, bioText, noBio }) {
  ...
  return (
    <header className="mb-20 md:mb-20 xl:mb-20" id="header">
      <div className="fixed-target" id="fixed-target"></div>
      <div className="flex items-center relative z-10">
        <Link href="/">
          <a className="flex flex-wrap space-x-2 items-center mr-auto">
            ...
            <span className="block uppercase tracking-tight leading-none md:leading-none xl:leading-none text-sm md:text-lg xl:text-xl 2xl:text-2xl 2xl:leading-none">Britt<span className="block">Connects</span></span>
          </a>
        </Link>
        ...
        {!noBio ? (
          <button onClick={ToggleBio} className="block uppercase tracking-tight leading-none md:leading-none xl:leading-none text-xl md:text-3xl xl:text-4xl 2xl:text-5xl ml-auto px-2 2xl:px-3 pt-[3px] pb-[2px] rounded-full border-yellow border hover:bg-yellow hover:text-off-black focus:bg-yellow focus:text-off-black focus:outline-none ring-offset-4 ring-offset-off-black focus:ring-[2px] ring-yellow">Bio</button>
        ) : (
          <div className="block uppercase tracking-tight leading-none md:leading-none xl:leading-none text-xl md:text-3xl xl:text-4xl 2xl:text-5xl ml-auto px-2 2xl:px-3 pt-[3px] pb-[2px] rounded-full border-yellow border hover:bg-yellow hover:text-off-black focus:bg-yellow focus:text-off-black focus:outline-none ring-offset-4 ring-offset-off-black focus:ring-[2px] ring-yellow opacity-0">Bio</div>
        )}
      </div>
      
      {bioOpen && (
        <div className="absolute inset-0 h-screen w-full bg-off-black z-50 p-4 md:p-6 xl:p-10" data-scroll data-scroll-sticky data-scroll-target="#fixed-target">
          <button onClick={ToggleBio} className="absolute top-0 right-0 m-8 md:m-12 xl:m-16 z-50 block uppercase tracking-tight leading-none md:leading-none xl:leading-none text-xl md:text-2xl xl:text-3xl 2xl:text-4xl ml-auto px-3 2xl:px-4 pt-[3px] pb-[2px] rounded-full border-yellow border hover:bg-yellow hover:text-off-black focus:bg-yellow focus:text-off-black focus:outline-none ring-offset-4 ring-offset-off-black focus:ring-[2px] ring-yellow">Close</button>
          ...
          <div className="flex flex-wrap h-full w-full">
            <div className="w-full h-[55%] relative">
              ...
              <span className="block absolute bottom-0 left-0 text-2xl mb-[-40px]">&darr;</span>
            </div>

            <div className="w-11/12 md:w-10/12 max-w-[1800px] h-[45%] flex">
              <div className="mt-auto">
                <p className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl indent-[15vw] leading-[0.9] mb-8">{bioHeading}</p>

                <p className="text-lg md:text-xl xl:text-2xl leading-tight w-8/12 md:w-1/2">{bioText}</p>
              </div>
            </div>
          </div>
        </div>
