  ...
  return (
    <header className="mb-20 md:mb-20 xl:mb-20" id="header">
      ...
      <div className="flex items-center relative z-10">
        <Link href="/">
          <a className="flex flex-wrap space-x-2 items-center mr-auto focus:outline-none focus:border-none focus:outline-none ring-offset-4 ring-offset-off-black focus:ring-[2px] ring-yellow">
