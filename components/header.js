          ...
          {bioOpen && (
            <>
              <m.div
                ...
                exit={{ opacity: 0 }}
                transition={{ duration: .480, ease: [0.83, 0, 0.17, 1] }}
                className="absolute inset-0 w-full h-screen bg-off-black z-40"
              >
              </m.div>
              <m.div
                initial={{ x: '100%' }}
                ...
                className="absolute top-0 right-0 bottom-0 h-screen w-[90vw] bg-off-black z-50"
              >
                  ...
                  <div className="flex flex-wrap h-full w-full">
                    ...
                    <div className="w-11/12 md:w-10/12 max-w-[1800px] h-[45%] flex">
                      <div className="mt-auto">
                        <p className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-[90px] indent-[15vw] leading-[0.9] mb-8">{bioHeading}</p>

                        <p className="text-lg md:text-xl xl:text-2xl leading-tight w-8/12 md:w-1/2 xl:w-[75%] 2xl:w-[60%]">{bioText}</p>
                      </div>
                    </div>
                  </div>
                </div>
