  ...
  return (
    <header className="mb-20 md:mb-20 xl:mb-20" id="header">
      ...
      <div className="flex items-center relative z-10">
        <div className="flex flex-wrap space-x-2 items-center mr-auto">
        ...
        <div className="absolute inset-0 h-screen w-full bg-off-black z-50 p-4 md:p-6 xl:p-10" data-scroll data-scroll-sticky data-scroll-target="#fixed-target">
          ...
          <div className="flex flex-wrap h-full w-full">
            <div className="w-full h-[55%] relative">
              <img src="images/britt-full.jpg" alt="placeholder" className="w-full h-full absolute inset-0 object-cover object-center" />
            ...
            <div className="w-11/12 md:w-10/12 max-w-[1800px] h-[45%] flex">
              <div className="mt-auto">
                <p className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl indent-[15vw] leading-[0.9] mb-8">With over 10 years experience, Britt has worked at some of world’s leading brand and design agencies.</p>

                <p className="text-lg md:text-xl xl:text-2xl leading-tight w-8/12 md:w-1/2">Award winning creative veteran? Excellent. Recent grad? Great. Top design school or internship? Wonderful. Quality portfolios and validated experience only.</p>
              </div>
            </div>
          </div>
        </div>
