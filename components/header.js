  ...
  return (
    <header className="mb-20 md:mb-20 xl:mb-20" id="header">
      ...
      <div className="flex items-center relative z-10">
        ...
        <span className="block tracking-tight leading-none md:leading-none xl:leading-none text-sm md:text-lg xl:text-xl mx-auto relative overflow-hidden">
