  ...
  return (
    <header className="p-3 md:p-4 xl:p-6 fixed top-0 left-0 right-0 z-[100]" id="header" data-scroll data-scroll-sticky data-scroll-target="#__next">
      ...
      <div className="flex items-center relative z-10">
        <Link href="/">
          <a className="flex flex-wrap space-x-2 items-center mr-auto focus-visible:outline-none focus-visible:border-none ring-offset-4 ring-offset-off-black focus-visible:ring-[2px] ring-yellow">
        ...
        <button onClick={ToggleBio} className="block uppercase tracking-tight leading-none md:leading-none xl:leading-none text-[22px] md:text-[38px] xl:text-[44px] 2xl:text-[52px] ml-auto px-2 md:px-3 2xl:px-4 pt-[3px] md:pt-[4px] pb-[2px] md:pb-[2px] rounded-full border-yellow border focus-visible:outline-none ring-offset-4 ring-offset-off-black focus-visible:ring-[2px] ring-yellow relative overflow-hidden group hover:text-off-black transition-colors ease-in-out duration-500 bg-off-black">
            ...
            <>
              ...
              >
                <div className="h-screen p-4 md:p-6 xl:p-10" data-scroll data-scroll-sticky data-scroll-target="#fixed-target">
                  ...
                  <button onClick={ToggleBio} className="absolute top-0 right-0 m-8 md:m-12 xl:m-16 z-50 block uppercase tracking-tight leading-none md:leading-none xl:leading-none text-[22px] md:text-[38px] xl:text-[44px] 2xl:text-[52px] ml-auto px-2 md:px-3 2xl:px-4 pt-[3px] md:pt-[4px] pb-[2px] md:pb-[2px] rounded-full border-yellow border focus-visible:outline-none ring-offset-4 ring-offset-off-black focus-visible:ring-[2px] ring-yellow overflow-hidden group hover:text-off-black transition-colors ease-in-out duration-500">
                  <span className="absolute bottom-0 left-0 right-0 bg-yellow z-[0] h-0 group-hover:h-full transition-all ease-in-out duration-[400ms]"></span>
                    <span className="block overflow-hidden relative z-[10]">
                      <span>Close</span>
                    </span>
